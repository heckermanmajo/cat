...
echo "[3/5] Building browser extension..."
...
# 5. Stop existing server on port 3000
echo "[5/5] Stopping existing server on port 3000..."
lsof -ti:3000 | xargs kill -9 2>/dev/null || true
sleep 1

# 6. Start new server (in foreground - Ctrl+C to stop)
